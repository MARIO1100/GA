                ...
                <h1>MC RULES - CONTROLPANEL</h1>
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <input type="text" className="form-control" placeholder="Cell Phone"  value={this.state.fCellphone} onChange={this.handleFCellphoneChange.bind(this)} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col">
                        ...
                        <div className="col">
                            <label htmlFor="formGroupExampleInput" >Cell Phone Number</label>
                            <input type="text" className="form-control" placeholder="Cell Phone" value={this.state.sCellphone} onChange={this.handleSCellphoneChange.bind(this)} />
                        </div>
                    </div>
